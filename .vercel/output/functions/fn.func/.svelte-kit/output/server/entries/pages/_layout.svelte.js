import { c as create_ssr_component, b as compute_rest_props, g as get_current_component, d as spread, e as escape_attribute_value, f as escape_object, h as add_attribute, s as setContext, o as onDestroy, i as subscribe, v as validate_component, j as escape } from "../../chunks/index2.js";
...
import { f as forwardEventsBuilder, c as classMap, d as dispatch, a as classAdderBuilder } from "../../chunks/Ripple.js";
import { R as Row, B as BarTitle } from "../../chunks/Title.js";
...
const css = {
  code: ".drawer-container.svelte-1slebek{position:relative;display:flex;height:100%;border:1px solid var(--mdc-theme-text-hint-on-background, rgba(0, 0, 0, 0.1));overflow:hidden;z-index:0}.flexor-content.svelte-1slebek{flex-basis:0;height:0;flex-grow:1;overflow:hidden}.svelte-1slebek .app-content{flex:auto;overflow:hidden;position:relative;flex-grow:1;padding:35px}",
  map: null
};
      ...
      {},
      {
        default: () => {
          return `${validate_component(Row, "Row").$$render($$result, {}, {}, {
			...
			${validate_component(BarTitle, "BarTitle").$$render($$result, {}, {}, {
                    default: () => {
                      return `Quotes ${escape(path)}`;
                    }
                  })}`;
                }
              })}`;
...
<div class="flexor-content svelte-1slebek"><div class="drawer-container svelte-1slebek">${validate_component(Drawer, "Drawer").$$render(
      $$result,
          ...
          return `${validate_component(Header, "Header").$$render($$result, {}, {}, {
            default: () => {
              return `${validate_component(Title, "Title").$$render($$result, {}, {}, {
                ...
                default: () => {
                  return `<hr class="svelte-1slebek">`;
                }
              })}`;
            }
          })}
              ...
              return `${validate_component(List, "List").$$render($$result, {}, {}, {
                default: () => {
                  return `${validate_component(Item, "Item").$$render($$result, { href: "/" }, {}, {
					...
					<hr class="svelte-1slebek">
					${validate_component(Item, "Item").$$render($$result, { href: "/" }, {}, {
                    default: () => {
                      return `${validate_component(Text, "Text").$$render($$result, {}, {}, {
                        default: () => {
                          return `Save`;
